...
{
    [Serializable, VolumeComponentMenu("Ding Post-processing/15.3 FogWithNoise")]
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public CustomRenderPass(RenderPassEvent renderPassEvent, Material material, CustomVolumeComponent volume, string tag){
            //确定在哪个阶段插入渲染
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using(new ProfilingScope(cmd, m_ProfilingSampler)){
                ...
                material.SetFloat("_NoiseAmount", volume.NoiseAmount.value);
    ...
    public override void Create()
    {
        ...
        m_ScriptablePass = new CustomRenderPass(settings.Event, settings.material, volume, name);
    }
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        if(settings.material == null){
            Debug.LogWarningFormat("材质丢失",GetType().Name);
            return;
        }
